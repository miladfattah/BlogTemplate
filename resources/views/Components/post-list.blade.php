<div class="container mx-auto p-10">
    <ul class="grid grid-cols-1 gap-1 sm:grid-cols-2 md:grid-cols-3 md:gap-8">
      ...
      <li class="bg-white dark:bg-gray-800 rounded-lg shadow-xl">
          <a href="{{ route('posts.show', $post->slug) }}" class="flex flex-col  justify-between group max-w-sm mx-auto overflow-hidden bg-white rounded-lg hover:shadow-lg dark:bg-gray-800 hover:bg-gray-200 transition duration-500 ease-in-out">
            <img
            class="object-cover object-center w-full h-24 opacity-90 rounded-lg group-hover:opacity-100 transition duration-500 ease-in-out"
             ...
             <div class="mt-2 flex-1 ">
                ...
                <div class="bg-gray-500 flex items-center px-6 py-3  rounded-lg rounded-b-none">
                    ...
                    <h1 class="mx-3 text-lg font-semibold ">نمایش</h1>
                </div>
             </div>
          </a>
    </li>
